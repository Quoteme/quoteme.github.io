...
<!-- End Google Tag Manager -->
  ...
  <link media="only screen and (max-device-width: 480px)" href="http://localhost:4000/css/mobile.css" type="text/css" rel="stylesheet" />
  <link media="only screen and (device-width: 768px)" href="http://localhost:4000/css/mobile.css" type="text/css" rel="stylesheet" />
