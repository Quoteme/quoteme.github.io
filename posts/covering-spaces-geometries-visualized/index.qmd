...
In SM64, positions are stored as tuples of three `floats`. However, a programmer at nintendo thought that casting to `short int`s for collision detection would be fine. (a completely valid idea tbh, after all Mario waas never intended to move out of bounds).
