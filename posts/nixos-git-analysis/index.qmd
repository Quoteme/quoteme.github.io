---
title: "I Had to Give Away All My Laptops Days Before a Deadline — NixOS Saved Me"
subtitle: |
    4 years of commits, one `git clone`, and I was back where I left off
...
abstract: |
    ...
    That's the promise of NixOS: your entire system, down to the kernel modules and dotfiles, lives in a git repo.
    In this post I analyze 4 years of my NixOS configuration history — 700+ commits — to see what that journey actually looks like in data.
---
